...
6 项完整历史测试：125 个跨页历史话题和 205 条跨页评论无条数截断；当前指派任务、已关闭话题、早期 @、自写上下文及曾关注关系；排除 PR 并补查缺失父话题；分页失败/评论数量不足时不发布报告；账号不符立即停止；已删除作者与长篇外部正文完整保留。完整导出不改变通知游标。
